...
from jiuwenavatar.instance_manager.config import (
    InstancesYamlError,
    PORT_TYPES,
    validate_instance_name,
)
from jiuwenavatar.common.utils import get_user_home

logger = logging.getLogger(__name__)


def get_instances_yaml_path() -> Path:
    """Return path to instances.yaml: ~/.jiuwenavatar/instances.yaml"""
    return get_user_home() / ".jiuwenavatar" / "instances.yaml"


def get_instances_dir() -> Path:
    """Return base directory for named instance workspaces: ~/.jiuwenavatar-instances/"""
    return get_user_home() / ".jiuwenavatar-instances"


def get_instance_workspace_path(name: str) -> Path:
    """Return workspace path for a named instance: ~/.jiuwenavatar-instances/<name>/"""
...
def _read_yaml_file(path: Path) -> dict:
    ...
    try:
        ...
        raise InstancesYamlError(
            ...
            f"    - Run 'jiuwenavatar-init' to recreate a valid template"
        ) from exc
...
# instances:
#   alice:
#     # workspace: /custom/path/alice  # optional, defaults to ~/.jiuwenavatar-instances/alice
#     ports:
#       agent_server: 28092
#       web: 29000
#       gateway: 29001
...
# - index 0: default instance (28092/29000/29001/29173)
...
def update_instances_yaml(
    ...
    from jiuwenavatar.instance_manager.config import calculate_instance_ports
