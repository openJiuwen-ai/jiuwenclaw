...
def get_default_instance_status() -> InstanceStatus:
    """Get status of the default instance (workspace at ~/.jiuwenavatar).
    ...
    if not running:
        ...
        from jiuwenavatar.instance_manager.config import is_port_available
...
def _find_pid_by_port(port: int) -> Optional[int]:
    ...
    try:
        if system == "windows":
            ...
            # Look for lines like: "TCP    0.0.0.0:28092    0.0.0.0:0    LISTENING    12345"
            # or: "TCP    127.0.0.1:28092    0.0.0.0:0    LISTENING    12345"
