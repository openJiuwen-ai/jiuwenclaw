...
from jiuwenavatar.common.e2a.agent_compat import e2a_to_agent_request
from jiuwenavatar.common.e2a.models import E2AEnvelope
from jiuwenavatar.gateway.routing.agent_client import AgentServerClient
from jiuwenavatar.common.schema.agent import AgentResponse, AgentResponseChunk
...
class YuanrongFrontendAgentClient(AgentServerClient):
    ...
    async def send_request(
        ...
        Args:
            envelope: E2A 信封
            timeout: 兼容基类签名；HTTP 调用的超时由底层 invoke 控制，这里不单独使用。
