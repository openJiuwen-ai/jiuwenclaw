...
from jiuwenavatar.common.utils import get_agent_sessions_dir, get_agent_workspace_dir, get_user_workspace_dir
...
class DiffService:
    ...
    def _read_agent_history(self, session_id: str | None = None, project_dir: str | None = None) -> dict[str, Any]:
        ...
        # 2. session-specific file_ops（如 file_ops_jiuwenavatar_tui_xxx.json）
        if session_id:
