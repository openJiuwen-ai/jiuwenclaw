...
"""Integration helpers for wiring A2UI into jiuwenavatar host modules.
...
from jiuwenavatar.server.runtime.a2ui.config import get_a2ui_config, get_current_a2ui_config
...
def _build_a2ui_client_event_prompt(content: dict[str, Any], channel: str, language: str) -> str:
    ...
    from jiuwenavatar.server.runtime.a2ui.runtime.prompt import build_a2ui_client_event_prompt
