...
from jiuwenavatar.server.runtime.a2ui.stream_guard import A2UIStreamGuard
from jiuwenavatar.server.runtime.a2ui.text_formatter import format_for_text_channel
from jiuwenavatar.server.runtime.a2ui.types import A2UIExample, A2UIResponsePart, A2UIValidationResult
from jiuwenavatar.server.runtime.a2ui.validator import (
...
def _normalize_prompt_contract(prompt: str) -> str:
    """Remove SDK default wording that conflicts with jiuwenavatar's v0.8 contract."""
...
class A2UIProtocolSpec:
    ...
    def build_prompt(self, language: str = "en") -> str:
        if language in {"zh", "cn"}:
            role = (
                "你是 jiuwenavatar 的 A2UI 生成器。遇到适合富交互界面的回答时，"
            ...
            role = (
                "You are jiuwenavatar's A2UI generator. When a rich interactive "
