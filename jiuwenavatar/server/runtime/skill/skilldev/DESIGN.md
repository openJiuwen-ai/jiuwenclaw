...
```
jiuwenavatar/agentserver/skilldev/
...
**存储路径**：
```
~/.jiuwenavatar/agent/workspace/skilldev/{task_id}/state.json
```
...
**目录结构**：
```
~/.jiuwenavatar/agent/workspace/skilldev/{task_id}/
...
**约定**：`~/.jiuwenavatar/agent/workspace/skilldev/{task_id}/`，由 `get_workspace_dir() / "skilldev"` 构造。
