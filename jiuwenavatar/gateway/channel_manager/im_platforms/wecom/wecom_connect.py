...
from jiuwenavatar.gateway.channel_manager.base import BaseChannel, ChannelMetadata, RobotMessageRouter
...
class WecomChannel(BaseChannel):
    ...
    async def _handle_incoming_message(self, frame: dict) -> None:
        """处理 SDK 收到的消息，转换为 jiuwenavatar Message 并分发。"""
    ...
    async def _run_client(self) -> None:
        ...
        # 初始化文件服务
        try:
            from jiuwenavatar.gateway.channel_manager.im_platforms.wecom.wecom_file_service import WecomFileService
