...
_CLI_CONFIG_YAML_SETTERS: dict[str, Any] = {
    ...
    # Auto-Harness config items (stored in ~/.jiuwenavatar/auto-harness/config.yaml)
...
def register_cli_handlers(bind: CliHandlersBindParams) -> None:
    ...
    async def _config_get(ws, req_id, params, session_id):
        ...
        try:
            ...
            for key, val in payload.items():
                from jiuwenavatar.extensions import ExtensionRegistry
    ...
    async def _history_list_turns(ws, req_id, params, session_id):
        from jiuwenavatar.agents.harness.common.session_ops_service import list_session_turns
    ...
    # ── Memory RPC handlers ────────────────────────────────────────────
    from jiuwenavatar.agents.harness.common.memory_rpc import (
        handle_memory_list,
        handle_memory_edit,
