...
from jiuwenavatar.common.service_ports import DEFAULT_GATEWAY_PORT
from jiuwenavatar.dotenv_early import parse_dotenv_early
parse_dotenv_early("jiuwenavatar-acp-channel")

# --- Now safe to import jiuwenavatar modules ---
from jiuwenavatar.gateway.channel_manager.base import BaseChannel, RobotMessageRouter
from jiuwenavatar.common.e2a.acp.protocol import (
...
from jiuwenavatar.common.e2a.adapters import envelope_from_acp_jsonrpc
from jiuwenavatar.common.e2a.constants import (
...
from jiuwenavatar.common.e2a.models import E2AEnvelope, E2AProvenance, E2AResponse, utc_now_iso
from jiuwenavatar.common.schema.message import EventType, Message, Mode, ReqMethod
...
class AcpGatewayBridge:
    ...
    async def inbound_intercept(self, ws: Any, data: dict[str, Any]) -> bool:
        ...
        from jiuwenavatar.common.e2a.adapters import build_acp_tool_response_message
...
class AcpChannel(BaseChannel):
    ...
    def _provenance(kind: str) -> E2AProvenance:
        return E2AProvenance(
            ...
            converter="jiuwenavatar.gateway.channel_manager.protocol.acp.acp_connect:AcpChannel",
...
def main() -> None:
    ...
    gateway_port = os.getenv("GATEWAY_PORT", str(DEFAULT_GATEWAY_PORT))
    gateway_url = (
