...
from jiuwenavatar.agents.harness.team.rails.team_member_skill_toolkit_rail import (
    MemberSkillToolkitRail,
)
from jiuwenavatar.agents.harness.team.rails.team_shared_skill_link_refresh_rail import (
    TeamSharedSkillLinkRefreshRail,
)
from jiuwenavatar.server.runtime.skill.skill_manager import SkillManager

from jiuwenavatar.agents.harness.team.bootstrap import configure_agent_teams_home

configure_agent_teams_home()

from jiuwenavatar.agents.harness.team.config_loader import (
    load_team_spec_dict,
)
...
from jiuwenavatar.agents.harness.team.remote_member_bootstrap import release_a2x_reservations_for_session
...
from jiuwenavatar.common.config import get_config, get_default_models
...
from jiuwenavatar.common.utils import get_agent_skills_dir, get_agent_workspace_dir
from jiuwenavatar.server.runtime.session.session_metadata import get_session_metadata
...
class TeamManager:
    ...
    def register_member_runtime_tools(
        ...
        *,
        ...
        from jiuwenavatar.agents.harness.common.tools.cron.cron_runtime import CronRuntimeBridge
        from jiuwenavatar.agents.harness.common.tools.send_file_to_user import SendFileToolkit
        ...
        *,
        ...
        def customizer(
            ...
            parent_adapter_mode = str(
                getattr(deep_agent, "_jiuwenavatar_adapter_mode", "") or ""
            ).lower()
            ...
            parent_project_dir = (
                str(getattr(deep_agent, "_jiuwenavatar_project_dir", "") or "")
                or str(getattr(deep_agent, "_jiuwenavatar_code_project_dir", "") or "")
                or (
            ...
            if parent_project_dir and member_deep_config is not None:
                setattr(agent, "_jiuwenavatar_project_dir", parent_project_dir)
            ...
            if parent_adapter_mode == "code":
                try:
                    from jiuwenavatar.server.runtime.agent_adapter.interface_code import (
    ...
    async def create_team(
        ...
        try:
            ...
            if self._is_distributed_mode(config_base):
                try:
                    from jiuwenavatar.agents.harness.team.remote_member_bootstrap import (
