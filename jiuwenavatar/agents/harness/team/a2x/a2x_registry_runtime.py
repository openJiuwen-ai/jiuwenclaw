...
async def init_a2x_client(config_base: dict[str, Any]) -> tuple[Any, dict[str, Any]]:
    ...
    from jiuwenavatar.agents.harness.team.a2x.client import AsyncA2XRegistryClient
    ...
    try:
        ...
        async def _restore() -> bool:
            if not resolved_service_id:
                ...
                from jiuwenavatar.agents.harness.team.a2x.client import _internal as _a2x_internal
