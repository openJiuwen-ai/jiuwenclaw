...
from jiuwenavatar.agents.harness.common.rails.avatar_rail import AvatarPromptRail
...
from jiuwenavatar.agents.harness.common.rails.stream_event_rail import JiuClawStreamEventRail
from jiuwenavatar.agents.harness.team.rails.team_workspace_report_path_rail import TeamWorkspaceReportPathRail
from jiuwenavatar.common.config import get_config
from jiuwenavatar.server.runtime.skill import load_execution_disabled_skills
...
def build_evolution_llm(
    ...
    from jiuwenavatar.common.openrouter_attribution import inject_attribution_headers
