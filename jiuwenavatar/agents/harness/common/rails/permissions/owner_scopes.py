...
逻辑集中在 ``jiuwenavatar.agents.harness.common.rails.permissions``，与 openjiuwen 工具护栏配合使用。
...
TOOL_PERMISSION_CONTEXT: contextvars.ContextVar[PermissionContext | None] = contextvars.ContextVar(
    "jiuwenavatar_tool_permission_context",
    default=None,
)
...
def persist_to_owner_scope(
    ...
    try:
        from jiuwenavatar.common.config import get_config_raw, set_config
