...
def build_permission_rail(
    ...
    from jiuwenavatar.agents.harness.common.rails.permissions.tool_permission_context import (
        TOOL_PERMISSION_CHANNEL_ID,
    )
    from jiuwenavatar.common.config import get_config
    from jiuwenavatar.common.e2a.acp.acp_tool_updates import build_acp_tool_descriptor
    from jiuwenavatar.common.utils import get_config_file, get_workspace_dir
    ...
    try:
        def _persist_allow_rule(permissions: dict[str, Any]) -> bool:
            ...
            """
            try:
                from jiuwenavatar.common.config import _dump_yaml_round_trip, _load_yaml_round_trip
        ...
        async def _request_permission_confirmation(
            ...
            from jiuwenavatar.agents.harness.common.tools.acp_output_tools import get_acp_output_manager
        ...
        async def _permission_scene_hook(
            ...
            from jiuwenavatar.agents.harness.common.rails.permissions.owner_scopes import (
