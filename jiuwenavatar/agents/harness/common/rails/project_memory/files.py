...
PROJECT_MEMORY_FILES: tuple[tuple[str, str], ...] = (
    ("JIUWENAVATAR.md", "project"),
    (".jiuwen/JIUWENAVATAR.md", "project"),
)

LOCAL_MEMORY_FILES: tuple[tuple[str, str], ...] = (
    ("JIUWENAVATAR.local.md", "local"),
)
...
ADDITIONAL_DIRECTORIES_ENV = "JIUWENAVATAR_ADDITIONAL_DIRECTORIES"
