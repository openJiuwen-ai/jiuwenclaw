...
class AutoHarnessService:
    ...
    def build_auto_harness_config(
        ...
        # to JiuwenAvatar's user workspace (~/.jiuwenavatar).
    ...
    async def create_scheduled_task(
        ...
        # Store just the model_name (model will be resolved from jiuwenavatar config at execution)
        model_name = None
        if model is not None:
