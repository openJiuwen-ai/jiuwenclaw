...
from jiuwenavatar.agents.harness.common.memory import (
    get_memory_manager,
    is_memory_enabled,
)
from jiuwenavatar.agents.harness.common.memory.config import is_proactive_memory
...
def _validate_edit_path(raw_path: str, workspace: str, project_dir: str | None = None) -> tuple[bool, str]:
    ...
    if basename in ("JIUWENAVATAR.md", "JIUWENAVATAR.local.md"):
...
async def handle_memory_toggle(
    ...
    from jiuwenavatar.common.config import update_memory_forbidden_enabled_in_config
...
def _update_mode_memory_config(mode: str, field: str, value: bool) -> None:
    from jiuwenavatar.common.config import _load_yaml_round_trip, _dump_yaml_round_trip, _CONFIG_YAML_PATH
