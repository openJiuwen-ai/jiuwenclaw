...
from jiuwenavatar.common.utils import wait_for_pid_exit, wait_for_tcp_port
...
def main() -> None:
    ...
    gateway_port: int = data.get("gateway_port", DEFAULT_WEB_PORT)
    frontend_port: int = data.get("frontend_port", DEFAULT_FRONTEND_PORT)
