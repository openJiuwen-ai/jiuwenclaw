...
from jiuwenavatar.common.e2a.constants import E2A_SOURCE_PROTOCOL_E2A
...
def _fallback_wire_unary_from_legacy(
    ...
    *,
    ...
    prov = E2AProvenance(
        ...
        converter="jiuwenavatar.common.e2a.wire_codec:_fallback_wire_unary_from_legacy",
        converted_at=ts,
...
def _fallback_wire_chunk_from_legacy(
    ...
    *,
    ...
    prov = E2AProvenance(
        source_protocol=E2A_SOURCE_PROTOCOL_E2A,
        converter="jiuwenavatar.common.e2a.wire_codec:_fallback_wire_chunk_from_legacy",
        converted_at=ts,
    ...
    *,
    ...
    e2a = E2AResponse(
        ...
        provenance=E2AProvenance(
            source_protocol=E2A_SOURCE_PROTOCOL_E2A,
            converter="jiuwenavatar.common.e2a.wire_codec:encode_json_parse_error_wire",
            converted_at=ts,
