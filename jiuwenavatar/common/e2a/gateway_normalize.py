...
E2A_INTERNAL_CONTEXT_KEY = "_jiuwenavatar"
...
def channel_context_for_channel_reply(env: E2AEnvelope) -> dict[str, Any] | None:
    """供流式 chunk 回传到 Channel：去掉内部 _jiuwenavatar，保留 trace 与业务 metadata。"""
...
def e2a_response_from_agent_response(
    ...
    *,
    ...
    """
    from jiuwenavatar.common.schema.agent import AgentResponse as AgentResponseCls
    ...
    prov = E2AProvenance(
        ...
        converter="jiuwenavatar.common.e2a.gateway_normalize:e2a_response_from_agent_response",
        converted_at=ts,
...
def e2a_response_from_agent_chunk(
    ...
    *,
    ...
    """
    from jiuwenavatar.common.schema.agent import AgentResponseChunk as AgentResponseChunkCls
    ...
    prov = E2AProvenance(
        source_protocol=E2A_SOURCE_PROTOCOL_E2A,
        converter="jiuwenavatar.common.e2a.gateway_normalize:e2a_response_from_agent_chunk",
        converted_at=ts,
...
def e2a_response_to_agent_response(e2a: E2AResponse) -> "AgentResponse":
    ...
    """
    from jiuwenavatar.common.schema.agent import AgentResponse
