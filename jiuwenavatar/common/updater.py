...
from jiuwenavatar.common.config import get_config_raw
from jiuwenavatar.common.version import __version__
from jiuwenavatar.common.upgrade_executor import create_executor
from jiuwenavatar.common.version_source import (
...
DEFAULT_ASSET_PATTERN_WINDOWS = "JiuwenAvatar-setup-{version}.exe"
DEFAULT_ASSET_PATTERN_MACOS = "JiuwenAvatar-{version}.dmg"
DEFAULT_ASSET_PATTERN_LINUX = "JiuwenAvatar-{version}.tar.gz"
...
class UpdaterService:
    ...
    def start_download(self) -> dict[str, Any]:
        ...
        thread = threading.Thread(
            ...
            daemon=True,
            name="JiuwenAvatar-Updater-download",
        )
    ...
    def _load_config() -> dict[str, Any]:
        ...
        repo = str(updater.get("repo_name") or "jiuwenavatar").strip()
