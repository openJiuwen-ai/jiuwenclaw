...
class ReqMethod(Enum):
    ...
    PERSONAS_DUPLICATE = "personas.duplicate"
    PERSONAS_GENERATE = "personas.generate"
    AVATARS_LIST = "avatars.list"
    AVATARS_GET = "avatars.get"
    AVATARS_CREATE = "avatars.create"
    AVATARS_UPDATE = "avatars.update"
    AVATARS_DELETE = "avatars.delete"
    ...
    # Missions & Reports（任务与报告）
    MISSIONS_LIST = "missions.list"
    MISSIONS_GET = "missions.get"
