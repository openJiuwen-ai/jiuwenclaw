...
parse_dotenv_early("jiuwenavatar-tui")

# --- Now safe to import jiuwenavatar modules ---
from jiuwenavatar.common.e2a.adapters import (
    e2a_response_to_acp_jsonrpc_response,
    envelope_from_acp_jsonrpc,
)
from jiuwenavatar.common.e2a.constants import E2A_RESPONSE_KIND_E2A_CHUNK
from jiuwenavatar.common.e2a.models import E2AResponse
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="jiuwenavatar-tui",
        description="JiuwenAvatar CLI 入口（子命令分发）。",
    )
...
def run_acp(args: argparse.Namespace) -> int:
    ...
    cmd = [sys.executable, "-m", "jiuwenavatar.gateway.channel_manager.protocol.acp.acp_connect"]
