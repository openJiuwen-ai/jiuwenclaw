...
export class AppScreen implements Component, Focusable {
  ...
  constructor(
    ...
    this.tui.terminal.setTitle("jiuwenavatar");
  ...
  private initStartupPrompt(): void {
    ...
    const items: SelectItem[] = [
      ...
      },
      {
        ...
        value: "no",
        description: "Only ~/.jiuwenavatar/agent/workspace will be accessible",
      },
    ];
  ...
  private handleStateChange(): void {
    ...
    if (snapshot.sessionTitle !== this.previousSessionTitle) {
      ...
      const rawTitle = snapshot.sessionTitle || "jiuwenavatar";
