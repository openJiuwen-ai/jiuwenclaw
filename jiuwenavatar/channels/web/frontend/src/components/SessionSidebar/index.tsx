...
const LOGO_ICON = '/jiuwen_avatar.png';
...
const mainNavItems: NavItem[] = [
  ...
  { key: 'avatars', labelKey: 'nav.avatars', icon: <img src={agentIcon} alt="" /> },
  { key: 'triggers', labelKey: 'nav.triggers', icon: <img src={cronIcon} alt="" /> },
  { key: 'reports', labelKey: 'nav.reports', icon: <img src={reportIcon} alt="" /> },
  { key: 'stats', labelKey: 'nav.stats', icon: <img src={statsIcon} alt="" /> },
  { key: 'channels', labelKey: 'nav.channels', icon: <img src={channelIcon} alt="" /> },
  { key: 'config', labelKey: 'nav.config', icon: <img src={configIcon} alt="" /> },
];
...
export function SessionSidebar({
  ...
  if (collapsed) {
    return (
      <aside ref={sidebarRef} className="sidebar sidebar--collapsed">
        ...
        {/* Separator + settings nav — only when items exist */}
  ...
  return (
    <aside className="sidebar">
      ...
      {/* Settings Section — hidden when empty */}
      {settingsNavItems.length > 0 && (
        <div className="nav-section">
