...
const JIUWENSWARM_REPO_URL = 'https://gitcode.com/openJiuwen/jiuwenavatar';
        ...
        <header className="share-image-header">
          <div className="share-image-masthead">
            <div className="share-image-brand">
              <img src="/jiuwen_avatar.png" alt="" className="share-image-brand__logo" />
              <div className="share-image-brand__name">JiuwenAvatar</div>
            </div>
          </div>
        </header>
