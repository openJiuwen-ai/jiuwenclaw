...
proxy: {
  '/api': {
    target: 'http://127.0.0.1:29000',  // Your backend URL
    changeOrigin: true,
  },
  '/ws': {
    target: 'http://127.0.0.1:29000',  // Your backend URL
...
Open http://localhost:29173

### Start Backend

```bash
cd jiuwenavatar
PORT=29000 python -m jiuwenavatar.api.app
```
...
- Log file: `jiuwenavatar/channels/web/frontend/logs/ws-dev.log`
...
```
jiuwenavatar/channels/web/frontend/
├── public/
│   └── logo.png           # App logo
├── src/
│   ├── components/
