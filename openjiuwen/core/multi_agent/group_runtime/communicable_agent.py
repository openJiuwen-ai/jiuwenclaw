...
class CommunicableAgent:
    ...
    subscriptions through a bound GroupRuntime.

    The runtime binding is set automatically by GroupRuntime.register_agent.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._runtime: Optional[GroupRuntime] = None
    ...
    def bind_runtime(
        ...
        """Bind a GroupRuntime to this agent.

        Called automatically by GroupRuntime.register_agent.

        Args:
            runtime: GroupRuntime instance
    ...
    def runtime(self) -> GroupRuntime:
        """The bound GroupRuntime."""
        if self._runtime is None:
            raise build_error(
                StatusCode.AGENT_GROUP_EXECUTION_ERROR,
                error_msg="Agent not bound to a GroupRuntime. "
                          "Register the agent with a GroupRuntime first."
            )
