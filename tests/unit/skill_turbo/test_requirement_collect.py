...
rc = _load_module(
    "jiuwenclaw.agentserver.skill_turbo.skill_codes.ppt.requirement_collect",
    _PKG_ROOT / "jiuwenclaw/agentserver/skill_turbo/skill_codes/ppt/requirement_collect.py",
)
