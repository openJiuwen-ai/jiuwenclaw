...
cp = _load_module(
    "jiuwenclaw.agentserver.replan_agent.skill_codes.ppt.content_plan",
    _PKG_ROOT / "jiuwenclaw/agentserver/replan_agent/skill_codes/ppt/content_plan.py",
)
...
def _base_ctx(**overrides: Any) -> dict[str, Any]:
    ctx: dict[str, Any] = {
        ...
        "search_mode": "auto",
        "source_type": "topic",
        "output_dir": str(_PKG_ROOT / "tests" / "unit" / "replan_agent" / "_tmp_p4"),
    }
