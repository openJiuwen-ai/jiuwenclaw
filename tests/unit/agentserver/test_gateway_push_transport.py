...
from jiuwenavatar.server.gateway_push.transport import WebSocketGatewayPushTransport
...
async def test_websocket_gateway_push_transport_forwards_to_ws_server(monkeypatch) -> None:
    ...
    monkeypatch.setitem(sys.modules, "jiuwenavatar.server.agent_ws_server", fake_module)
