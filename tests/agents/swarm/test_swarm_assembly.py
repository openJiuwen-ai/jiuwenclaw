...
def test_enrich_mounts_runtime_rails_on_named_llm_teammates() -> None:
    ...
    # toolkit (expert-team fix), plus the request runtime mounts from
    # _mount_named_teammate_runtime_rails (stream event + scoped MCP tools).
    ...
    # The reviewer's pre-declared STREAM_EVENT deduplicates to one mount.
