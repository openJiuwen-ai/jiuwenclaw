...
async def test_config_set_routes_team_payload_to_modes_team_helper(monkeypatch):
    ...
    monkeypatch.setattr("jiuwenavatar.gateway.channel_manager.web.app_web_handlers.get_config_raw",
                        lambda: {"preferred_language": "zh"})
    monkeypatch.setattr("jiuwenavatar.gateway.channel_manager.web.app_web_handlers.get_config",
                        lambda: {"modes": {"team": {}}})
    monkeypatch.setattr(
        "jiuwenavatar.gateway.channel_manager.web.app_web_handlers.replace_teams_in_config",
