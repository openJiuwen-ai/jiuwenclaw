...
from jiuwenavatar.common.config import get_config_raw, replace_teams_in_config, resolve_env_vars
...
""",
        ...
        monkeypatch.setattr("jiuwenavatar.common.config.CONFIG_YAML_PATH", temp_config_file)
...
""",
        ...
        monkeypatch.setattr("jiuwenavatar.common.config._CONFIG_YAML_PATH", temp_config_file)
