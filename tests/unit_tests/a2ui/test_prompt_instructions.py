...
from jiuwenavatar.server.runtime.a2ui.prompt_instructions import (
    build_a2ui_autonomy_instruction,
)
from jiuwenavatar.server.runtime.a2ui.runtime.prompt import (
...
def test_a2ui_zh_prompt_section_is_readable():
    ...
    assert "你是 jiuwenavatar 的 A2UI 生成器" in prompt
