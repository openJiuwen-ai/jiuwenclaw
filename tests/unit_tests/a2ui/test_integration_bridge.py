...
from jiuwenavatar.server.runtime.a2ui import integration
from jiuwenavatar.server.runtime.a2ui.integration import (
...
def test_message_handler_fallback_skips_a2ui_import_without_marker(monkeypatch):
    ...
    from jiuwenavatar.gateway.message_handler.message_handler import (
    ...
    def guard_import(name, *args, **kwargs):
        if name == "jiuwenavatar.server.runtime.a2ui.integration":
