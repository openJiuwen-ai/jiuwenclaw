...
`jiuwenavatar.utils.get_config_file` and `get_agent_workspace_dir` before
importing the modules under test (so `jiuwenavatar.agentserver.memory.config` sees
...
import jiuwenavatar.common.utils as _utils
