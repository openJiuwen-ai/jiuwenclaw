...
def test_register_member_runtime_tools_adds_cron_and_send_file(monkeypatch):
    ...
    monkeypatch.setattr(
        "jiuwenavatar.agents.harness.common.tools.cron.cron_runtime.CronRuntimeBridge",
        _FakeCronRuntimeBridge,
    )
    monkeypatch.setattr(
        "jiuwenavatar.agents.harness.common.tools.send_file_to_user.SendFileToolkit",
