...
from jiuwenavatar.agents.harness.team.team_skill_links import link_skill_dir, remove_skill_dir_link
...
async def test_team_shared_skill_link_refresh_rail_refreshes_after_global_skill_write(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "jiuwenavatar.agents.harness.team.rails.team_shared_skill_link_refresh_rail.get_cwd",
        lambda: str(tmp_path),
    )
    global_skills_dir = tmp_path / "global_skills"
    skill_dir = global_skills_dir / "skill-a"
