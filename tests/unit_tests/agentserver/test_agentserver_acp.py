...
from jiuwenavatar.server.runtime.agent_manager import ACP_DEFAULT_CAPABILITIES
from jiuwenavatar.agents.harness.common.tools import acp_output_tools
from jiuwenavatar.agents.harness.common.tools.acp_output_tools import AcpOutputRequest, get_acp_output_manager
from jiuwenavatar.server.runtime.agent_adapter import interface_deep as interface_deep_module
from jiuwenavatar.server.runtime.agent_adapter import team_helpers as team_helpers_module
...
async def test_handle_team_delete_deletes_all_matching_team_sessions(monkeypatch):
    ...
    monkeypatch.setattr(
        "jiuwenavatar.agents.harness.team.stop_team_session_runtime_across_managers",
...
async def test_handle_session_delete_initializes_persistent_checkpointer(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "jiuwenavatar.server.runtime.session.session_metadata.get_session_metadata",
