...
def test_team_config_loader_ignores_yaml_enable_team_plan():
    from jiuwenavatar.agents.harness.team.config_loader import load_team_spec_dict
...
def test_agent_manager_creates_code_adapter_for_code_team(monkeypatch):
    from jiuwenavatar.server.runtime import agent_manager as agent_manager_module
    from jiuwenavatar.server.runtime.agent_adapter import interface as interface_module
