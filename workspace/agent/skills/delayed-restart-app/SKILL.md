...
```bash
python %USERPROFILE%\.jiuwenclaw\workspace\agent\skills\delayed-restart-app\launch_delayed_restart.py --pid <当前 app 的 PID> --delay 5
```

（Unix/macOS 使用：`python ~/.jiuwenclaw/workspace/agent/skills/delayed-restart-app/launch_delayed_restart.py --pid <PID> --delay 5`）
