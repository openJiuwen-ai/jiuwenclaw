...
async def push_service_config_templates_op(
    jiuwenclaw_id: str,
    op: str,
    *,
    template: dict[str, Any] | None = None,
...
async def push_service_config_templates_sync_to_gateway(
    handler: DBHandler,
    jiuwenclaw_id: str,
) -> dict[str, Any]:
    ...
    return await push_service_config_templates_op(jid, "sync", templates=templates)
