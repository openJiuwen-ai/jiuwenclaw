...
class ServiceConfigTemplateService:
    ...
    def _build_row_for_create(
        ...
        return {
            ...
            "port_name": body.port_name.strip(),
            "image_pull_policy": _normalize_image_pull_policy(body.image_pull_policy),
            ...
            "nfs_path": body.nfs_path.strip(),
            "nfs_mount_path": body.nfs_mount_path.strip() if body.nfs_mount_path else None,
            "agent_cpu_request": body.agent_cpu_request.strip(),
            "agent_memory_request": body.agent_memory_request.strip(),
            "agent_cpu_limit": body.agent_cpu_limit.strip(),
            "agent_memory_limit": body.agent_memory_limit.strip(),
            "jiuwenbox_cpu_request": body.jiuwenbox_cpu_request.strip(),
            "jiuwenbox_memory_request": body.jiuwenbox_memory_request.strip(),
            "jiuwenbox_cpu_limit": body.jiuwenbox_cpu_limit.strip(),
            "jiuwenbox_memory_limit": body.jiuwenbox_memory_limit.strip(),
