...
class ServiceConfigTemplateCreateBody(BaseModel):
    ...
    cpu_request: str = Field(default="500m", max_length=32)
    memory_request: str = Field(default="512Mi", max_length=32)
    cpu_limit: str = Field(default="1000m", max_length=32)
    memory_limit: str = Field(default="1Gi", max_length=32)
