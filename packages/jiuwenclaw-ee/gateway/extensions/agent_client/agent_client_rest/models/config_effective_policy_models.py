...
class ConfigEffectiveServicePolicyInfo(BaseModel):
    id: int
    service_id: str
    jiuwenclaw_id: str
    priority: int
...
class ConfigEffectiveAgentPolicyInfo(BaseModel):
    id: int
    agent_id: str
    jiuwenclaw_id: str
...
class ConfigEffectiveGlobalPolicyInfo(BaseModel):
    id: int
    jiuwenclaw_id: str
    default_model: str | None
    video_model: str | None
