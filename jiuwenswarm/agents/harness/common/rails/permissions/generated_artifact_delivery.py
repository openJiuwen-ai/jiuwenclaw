...
_SEND_FILE_EXECUTION_GRANT: contextvars.ContextVar[SendFileExecutionGrant | None] = (
...
def publish_send_file_execution_grant(
    ...
    _SEND_FILE_EXECUTION_GRANT.set(grant)
    return grant
...
def current_send_file_execution_grant() -> SendFileExecutionGrant | None:
    ...
    return _SEND_FILE_EXECUTION_GRANT.get()
...
def consume_send_file_execution_grant(
    ...
    *,
    ...
    grant = _SEND_FILE_EXECUTION_GRANT.get()
    _SEND_FILE_EXECUTION_GRANT.set(None)
    if grant is None:
