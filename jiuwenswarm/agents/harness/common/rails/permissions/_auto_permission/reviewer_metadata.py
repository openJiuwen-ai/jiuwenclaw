...
_DISPLAY_MESSAGES = {
    ...
    "execution_provider_contract_unverified": (
        ...
        "The Host cannot verify this tool's execution-provider contract, so manual confirmation is required. Manual approval does not change the tool's actual execution environment.",
    ),
    "low_confidence": (
    ...
    "manual_required": (
        ...
        "Current permission evidence is insufficient for automatic approval; review the tool parameters and risks manually.",
    ),
    "reviewer_fallback": (
