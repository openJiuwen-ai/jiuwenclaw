...
def _evaluate_paths(
    ...
    *,
    ...
    for path in canonical_paths:
        ...
        current_precedence = precedence.get(level)
        strictest_precedence = precedence.get(strictest_level)
        if current_precedence is None or strictest_precedence is None:
            return _unevaluable(
                "send_file_path_guard_result_unknown",
                canonical_paths,
            )
        if current_precedence > strictest_precedence:
