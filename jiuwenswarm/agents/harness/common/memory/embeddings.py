...
class OpenAICompatibleEmbeddingProvider(EmbeddingProvider):
    ...
    def __init__(
        ...
        self.api_key = api_key or read_env("EMBED_KEY") or read_env("EMBED_API_KEY") or embed_config.get("api_key",
                                                                                                           "")
        self.model = model or read_env("EMBED_MODEL") or read_env("EMBEDDING_MODEL") or embed_config.get("model", "")
        self.base_url = base_url or read_env("EMBED_BASE") or read_env("EMBED_BASE_URL") or embed_config.get(
            "base_url", "")
