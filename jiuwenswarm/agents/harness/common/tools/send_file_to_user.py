        ...
        try:
            ...
            if envelope.require_execution_authorization:
                ...
                for file_path in valid_files:
                    asset = envelope.asset_owner.stage(
                        Path(file_path),
            ...
            # History persistence is a token-exposure boundary. Once entered,
            # uncertain failure or cancellation must preserve staged assets to TTL.
