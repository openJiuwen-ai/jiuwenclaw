            ...
            [
                {
                    ...
                    "content": (
                        ...
                        f"{sub_agent_desc}\n\n"
                        "For browser tasks, call the browser_cdp_sub sub-agent."
                        " For other tasks, use the MCP tools or add_local.\n"
...
async def main():
    ...
    # Override with EXAMPLE_QUERY env var
    # (e.g. for browser sub-agent: "Open https://example.com and tell me the title").
    query = (
        "Use the reasoning tool to solve: if 3x + 5 = 14, what is x? Reply with the value of x.\n"
        "Use that value of x to open https://www.roastful.com/top-roasters#top-50"
        " and find the position of the roaster on the list.\n"
