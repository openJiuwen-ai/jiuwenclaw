    ...
    def get_tools(self) -> list[Tool]:
        ...
        return [
            make_tool(
                name="search_skill",
                description=(
                    "Search skills that can be installed. The default source is SkillNet; "
                    "use source='auto' to search SkillNet, ClawHub, TeamSkillsHub, and "
                    "built-in skills in one call. Combine related requirements into one "
                    "query. Results include the identifier and source required by install_skill."
                ),
                input_params={
                    "type": "object",
                    "properties": {
                        ...
                        "source": {
                            ...
                            "description": (
                                "Where to search. Defaults to skillnet; use auto to search "
                                "all available sources in one call."
                            ),
                            "default": "skillnet",
                        },
                        "limit": {
