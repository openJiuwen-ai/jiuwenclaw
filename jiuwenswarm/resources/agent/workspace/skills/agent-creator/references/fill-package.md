...
| 文件                  | 参考                             | 要点                                                                                                            |
| ------------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| `manifest.json`     | `@references/manifest-spec.md` | 展示字段填实；`displayName` / `category` 必填；`avatar` 固定 `""`；`agentCard.id` = 目录名；禁止写 `model` / `mcps` / `subagents` |
| `README.md`         | —                              | 与核心能力一致                                                                                                       |
...
```json
{
  "file": "tools/<name>.py",
  "class": "<PascalCase>",
  "displayName": { "en": "<tool_or_rail_id>", "zh": "<tool_or_rail_id>" },
  "displayDescription": {
