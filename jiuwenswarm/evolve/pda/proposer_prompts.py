...
"""PDA Proposer system prompt — governance-aware Proposal generation.

Pluggable: PDA algorithm owns this prompt. LLMProposer uses its own
PROPOSER_SYSTEM_PROMPT — no overlap.
"""

PDA_PROPOSER_SYSTEM_PROMPT = """你是一名智能体演进提议专家。你将基于以下信息生成 Skill Experience Proposal。
