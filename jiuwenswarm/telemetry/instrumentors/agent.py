...
_tracer = trace.get_tracer("jiuwenswarm.agent")
...
def _store_agent_ctx(
    jiuwenswarm_server, ctx, channel_id: str = "", session_id: str = "", request_id: str = "",
) -> None:
    ...
    """
    instance = getattr(jiuwenswarm_server, "_instance", None)
