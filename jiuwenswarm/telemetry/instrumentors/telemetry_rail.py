...
from jiuwenswarm.telemetry.instrumentors.agent import RoutingCtx
...
def _hook_safe(method):
    ...
    async def wrapper(self, *args, **kwargs):
        ...
        try:
            ...
            fc = getattr(self, "_failure_count", 0) + 1
            setattr(self, "_failure_count", fc)
            ft = getattr(self, "_failure_threshold", 5)
            logger.warning(
...
class TelemetryRail(DeepAgentRail):
    ...
    async def before_model_call(self, ctx: Any) -> None:
        ...
        setattr(ctx, "_otel_llm_call_id", call_id)
    ...
    async def before_tool_call(self, ctx: Any) -> None:
        ...
        setattr(ctx, "_otel_tool_span_key", span_key)
    ...
    async def after_tool_call(self, ctx: Any) -> None:
        ...
        try:
            ...
            from jiuwenswarm.telemetry.metrics import record_genai_token_usage
