...
def instrument_tools() -> None:
    ...
    _original_emit_tool_call = getattr(JiuClawReActAgent, "_emit_tool_call", None)
    _original_emit_tool_result = getattr(JiuClawReActAgent, "_emit_tool_result", None)
    if _original_emit_tool_call is None or _original_emit_tool_result is None:
        logger.debug("[Telemetry] JiuClawReActAgent._emit_tool_* not found, skipping")
        return
    ...
    setattr(JiuClawReActAgent, "_emit_tool_call", _traced_emit_tool_call)
    setattr(JiuClawReActAgent, "_emit_tool_result", _traced_emit_tool_result)
