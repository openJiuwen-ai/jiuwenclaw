...
export interface CommandContext {
   ...
   * exits, onDone is called so the caller can report completion exactly once.
   * A false result means neither the configured nor fallback editor launched.
   */
  openInEditor?: (filePath: string, onDone?: (success?: boolean) => void) => void;
