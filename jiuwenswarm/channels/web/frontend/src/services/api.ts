 ...
 *
 * 个人版后端已在 web_http_sessions_compat.py 注册了 GET /api/sessions* 路由，
 * 但只有在企业版（is_enterprise()=true）时 ChatHistoryStore 才会写入数据，
 * 因此个人版下接口可调但通常返回空列表——前端按企业模式才展示 HistoryPanel。
 */
