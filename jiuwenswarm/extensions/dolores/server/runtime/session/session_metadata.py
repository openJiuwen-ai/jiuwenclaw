...
from jiuwenswarm.extensions.dolores.common.utils import get_agent_sessions_dir
from jiuwenswarm.extensions.dolores.server.runtime.session.work_mode import (
...
def _build_project_lookup() -> tuple[
    ...
    """
    try:
        from jiuwenswarm.extensions.dolores.server.runtime.session.project_store import (
            list_projects,
