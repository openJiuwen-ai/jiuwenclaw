...
from jiuwenswarm.extensions.dolores.common.utils import get_agent_root_dir
from jiuwenswarm.extensions.dolores.common.work_mode import (
...
def find_or_create_code_project_for_dir(project_dir: str) -> Project | None:
    ...
    # 切换,持久化的 git 快照会过期。
    from jiuwenswarm.extensions.dolores.server.runtime.session.project_git import get_project_git_service
    try:
        if not restored:
