...
from jiuwenswarm.extensions.dolores.server.runtime.session.project_store import Project, save_project
...
def resolve_git_project(
    ...
    """
    from jiuwenswarm.extensions.dolores.common.work_mode import is_default_project_id
    if not project_id:
    ...
    from jiuwenswarm.extensions.dolores.server.runtime.session import project_store
