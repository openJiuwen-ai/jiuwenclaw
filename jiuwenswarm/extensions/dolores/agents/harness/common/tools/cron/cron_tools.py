...
from jiuwenswarm.extensions.dolores.common.utils import get_cron_jobs_path
...
class CronTools:
    ...
    async def _send_split(self, action: str, params: dict[str, Any]) -> dict[str, Any]:
        from jiuwenswarm.extensions.dolores.common.e2a.constants import E2A_RESPONSE_KIND_CRON
    ...
    def _resolve_work_mode_from_params(
        ...
        *,
        ...
        Returns:
            ...
            失败时 ``work_mode`` 为空串。
        """
        from jiuwenswarm.extensions.dolores.server.runtime.session.work_mode import resolve_request_work_mode
    ...
    async def create_job(self, params: dict[str, Any]) -> Any:
        ...
        from jiuwenswarm.extensions.dolores.server.runtime.session.project_store import resolve_cron_project_binding
    ...
    async def update_job(self, job_id: str, patch: dict[str, Any]) -> Any:
        ...
        channel_id_val = self._resolve_channel_id() or "web"
        from jiuwenswarm.extensions.dolores.server.runtime.session.project_store import resolve_cron_job_patch
