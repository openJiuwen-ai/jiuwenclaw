...
class TokenJuiceRail(DeepAgentRail):
    ...
    def init(self, agent: Any) -> None:
        ...
        try:
            from jiuwenswarm.extensions.dolores.common.tokenjuice import load_rules
    ...
    async def after_tool_call(self, ctx: Any) -> None:
        ...
        # Build input
        from jiuwenswarm.extensions.dolores.common.tokenjuice import reduce_execution, ToolExecutionInput, ReduceOptions
