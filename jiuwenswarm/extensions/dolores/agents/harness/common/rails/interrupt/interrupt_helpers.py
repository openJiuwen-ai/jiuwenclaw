...
from jiuwenswarm.extensions.dolores.common.utils import logger
...
def build_permission_rail(
    ...
    from jiuwenswarm.extensions.dolores.agents.harness.common.rails.permissions.tool_permission_context import (
        TOOL_PERMISSION_CHANNEL_ID,
    )
    from jiuwenswarm.extensions.dolores.common.config import get_config
    from jiuwenswarm.extensions.dolores.common.e2a.acp.acp_tool_updates import build_acp_tool_descriptor
    from jiuwenswarm.extensions.dolores.common.utils import get_config_file, get_workspace_dir
    ...
    try:
        def _persist_allow_rule(permissions: dict[str, Any]) -> bool:
            ...
            """
            try:
                from jiuwenswarm.extensions.dolores.common.config import _dump_yaml_round_trip, _load_yaml_round_trip
        ...
        async def _request_permission_confirmation(
            ...
            from jiuwenswarm.extensions.dolores.agents.harness.common.tools.acp_output_tools import get_acp_output_manager
        ...
        async def _permission_scene_hook(
            ...
            from jiuwenswarm.extensions.dolores.agents.harness.common.rails.permissions.owner_scopes import (
...
def _question_options_from_ui_options(
    ...
    if options:
        return options
    return _default_interrupt_options()
