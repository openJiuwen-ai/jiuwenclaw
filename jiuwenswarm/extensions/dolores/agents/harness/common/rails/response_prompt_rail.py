...
from jiuwenswarm.extensions.dolores.common.context_keys import JIUWENSWARM_CHANNEL_CONTEXT_KEY
from jiuwenswarm.extensions.dolores.agents.harness.common.prompt.prompt_builder import (
    LocalSectionName,
    PromptPriority,
    _response_prompt,
)
...
class ResponsePromptRail(DeepAgentRail):
    ...
    def _sync_a2ui_prompt_section(self, channel: str | None, *, skip_a2ui: bool = False) -> None:
        ...
        try:
            from jiuwenswarm.extensions.dolores.server.runtime.a2ui.integration import is_a2ui_channel
            ...
            from jiuwenswarm.extensions.dolores.server.runtime.a2ui.config import get_current_a2ui_config
            from jiuwenswarm.extensions.dolores.server.runtime.a2ui.runtime.prompt import build_a2ui_prompt_section
