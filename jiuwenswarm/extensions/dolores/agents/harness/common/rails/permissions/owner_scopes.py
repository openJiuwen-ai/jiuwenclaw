...
async def check_avatar_permission(
    ...
    from jiuwenswarm.extensions.dolores.common.utils import get_workspace_dir
...
def persist_to_owner_scope(
    ...
    try:
        from jiuwenswarm.extensions.dolores.common.config import get_config_raw, set_config
