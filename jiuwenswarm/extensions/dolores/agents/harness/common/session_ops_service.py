...
from jiuwenswarm.extensions.dolores.common.utils import get_agent_sessions_dir, get_agent_workspace_dir
from jiuwenswarm.extensions.dolores.server.runtime.session.session_history import (
...
def rewind_session(
    *,
    ...
    from jiuwenswarm.extensions.dolores.server.runtime.session.session_history import truncate_history_records
    ...
    from jiuwenswarm.extensions.dolores.server.runtime.session.session_metadata import update_session_metadata
    ...
    if cut_timestamp is not None:
        try:
            from jiuwenswarm.extensions.dolores.server.utils.diff_service import get_diff_service
