...
class JiuWenSwarmDeepAdapter:
    ...
    def _build_runtime_tool_owner_id(self) -> str:
        """Compatibility alias for the Agent Core Tool ownership namespace."""
        return self._tool_owner_id()
    ...
    async def reload_agent_config(
        ...
        # Keep reload compatible with custom config objects that do not yet
        # expose Agent Core's optional Tool ownership field.
        if hasattr(deep_cfg, "tool_owner_id"):
            deep_cfg.tool_owner_id = self._tool_owner_id()
