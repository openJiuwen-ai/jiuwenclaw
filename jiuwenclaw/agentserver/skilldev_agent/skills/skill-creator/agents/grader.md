...
Scan the transcript and outputs for claims that go beyond the predefined expectations. Focus on claims that, if wrong, would change the grading outcome. Skip trivial or obvious claims.
...
Keep this step proportional — 3–5 claims is usually enough. Don't exhaustively catalog every statement.
