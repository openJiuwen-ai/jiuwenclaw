...
async def precheck_and_reserve_remote_spawn(
    ...
    *,
    ...
    try:
        from jiuwenclaw.agentserver.team.a2x.a2x_registry_runtime import reserve_blank_teammate_agent
...
async def _replace_teammate_card_after_direct_bootstrap(
    *,
    ...
    try:
        from jiuwenswarm.server.agent_ws_server import AgentWebSocketServer
        from jiuwenclaw.agentserver.team.a2x.a2x_registry_runtime import replace_teammate_agent_card_after_bootstrap
...
async def apply_team_destroy_envelope_from_control_plane(
    *,
    ...
    try:
        from jiuwenswarm.common.config import get_config as _get_config
        from jiuwenclaw.agentserver.team.a2x.a2x_registry_runtime import (
