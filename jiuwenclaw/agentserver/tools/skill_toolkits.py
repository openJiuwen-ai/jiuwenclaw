...
class SkillToolkit:
    ...
    def _enterprise_user_id(self) -> str | None:
    ...
    def _enterprise_routing(self) -> tuple[str | None, str | None, str | None]:
        from jiuwenclaw.agentserver.tools.cron_tool_context import get_cron_tool_metadata
        from jiuwenclaw.gateway.cron.enterprise_gate import extract_routing_triple
        ...
        try:
            ...
            if self._is_enterprise():
                ...
                result = await install_from_channel(
                    ...
                    remove_skill_dir=self._manager._remove_skill_directory,
                    group_id=group_id,
                    bot_id=bot_id,
