...
from jiuwenclaw.agentserver.skill_turbo.rails import SkillTurboArtifactRail
...
if TYPE_CHECKING:
    from jiuwenclaw.agentserver.skill_turbo.environment import SkillTurboEnvironment
    from jiuwenclaw.agentserver.skill_turbo.evolver import SkillTurboEvolver
...
class SkillTurboExecutor:
    ...
    def bind_node_callbacks(self, root: PlanNode) -> None:
        """公共接口：向 PlanNode 注入 runtime callbacks。"""
        self._bind_node_callbacks(root)
