...
if TYPE_CHECKING:
    from jiuwenclaw.agentserver.skill_turbo.environment import SkillTurboEnvironment, Skill

logger = logging.getLogger(__name__)

_SKILL_CODES_PACKAGE = "jiuwenclaw.agentserver.skill_turbo.skill_codes"
