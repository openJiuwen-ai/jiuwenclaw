...
export const useChatStore = create<ChatState>((set, get) => ({
  ...
  setSwitchingMode: (_switching) => {
    // Placeholder for switching mode state management
    // Currently not used in basic web version
  },

  setNewSession: (_isNew) => {
    // Placeholder for new session state management
    // Currently not used in basic web version
  },
