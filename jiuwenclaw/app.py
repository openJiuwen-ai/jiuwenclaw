...
from jiuwenclaw.config import (
    ...
    update_proactive_memory_in_config,
...
_CONFIG_YAML_KEYS = frozenset({"context_engine_enabled", "memory_enabled", "proactive_memory", "permissions_enabled"})
...
def _register_web_handlers(
    ...
    async def _config_get(ws, req_id, params, session_id):
        ...
        try:
            ...
            payload["proactive_memory"] = "true" if mem_cfg.get("proactive_memory", True) else "false"
            ...
            payload.setdefault("proactive_memory", "true")
    ...
    async def _config_set(ws, req_id, params, session_id):
        ...
        for param_key in _CONFIG_YAML_KEYS:
            ...
            try:
                ...
                elif param_key == "proactive_memory":
                    update_proactive_memory_in_config(parsed)
