...
from jiuwenclaw.extensions.agent_client.models.physical_resource_models import (
    RESOURCE_CONFIG_TABLE_DEF,
)
from jiuwenclaw.extensions.agent_client.schemas.physical_resource_schemas import (
