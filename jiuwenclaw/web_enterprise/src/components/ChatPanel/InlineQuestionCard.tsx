          ...
          <div className="flex items-center gap-2">
            {isEvolution ? (
              ...
              <svg
                ...
                style={{ color: borderColor }}
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 9.75a3.375 3.375 0 116.75 0c0 1.473-.956 2.725-2.281 3.167-.6.2-1.094.78-1.094 1.413V15m.563 3h.008v.008h-.008V18z" />
              </svg>
            ) : (
              <svg
                className="w-3.5 h-3.5 flex-shrink-0"
            ...
            {isSubagentTool && (
              <span className="text-[10px] px-1.5 py-0.5 rounded" style={{ color: 'var(--accent-2)', border: '1px solid var(--accent-2)' }}>
                来自子Agent
              </span>
            )}
            {isBatch && (
