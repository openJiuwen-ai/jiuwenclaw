...
if [[ $# -lt 3 ]]; then
  ...
  echo "example: $0 jiuwenclaw/resources/agent/workspace/skills/ascend-moe-optimizer-auto-trace build/cam/comm_operator build/cam/comm_operator/compile_ascend_proj.sh"
  exit 1
fi
