...
BUSINESS_MIRROR_KEYS: frozenset[str] = frozenset(
    {
        ...
        # Sandbox (config.get_sandbox_* via get_local_config)
        "JIUWENCLAW_SANDBOX_ENABLED",
        "JIUWENCLAW_SANDBOX_URL",
        "JIUWENCLAW_SANDBOX_TYPE",
        "JIUWENCLAW_SANDBOX_STARTUP_MODE",
        "JIUWENCLAW_SANDBOX_POLICY_FILE",
        "JIUWENCLAW_SANDBOX_PRESERVE_FILE_SHARING_MODE",
        "JIUWENCLAW_SANDBOX_EXCLUDED_COMMANDS",
        "JIUWENCLAW_SANDBOX_FILES_ALLOW",
        "JIUWENCLAW_SANDBOX_FILES_DENY",
        "JIUWENCLAW_SANDBOX_IDLE_TTL_SECONDS",
        "JIUWENCLAW_SANDBOX_IDLE_CHECK_INTERVAL",
    }
)
