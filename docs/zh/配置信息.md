...
![开启技能自动学习](../assets/images/skill演进_开关.png)
...
| 开关 | 对应配置 | 默认值 | 作用 |
| --- | --- | --- | --- |
| **启用技能自动学习** | `react.evolution.skill_evolution` | `false` | 统一控制自动 Skill 创建建议与 Skill 演进。关闭后相关 Rails、工具、提示词、watcher 和 `/evolve` 指令均不可用 |
...
- 在技能总谱页可查看演进历史和变更详情
- 通过 `/evolve <skill_name> [user_query]` 可立即发起指定 Skill 的演进审查
