...
![技能总谱](../assets/images/symphony_score.png)
...
![技能交响乐配置](../assets/images/symphony_config.png)
...
![技能编排对话示例](../assets/images/symphony_example.png)
...
当前 Web 配置页提供三个相关开关：**启用技能检索** 控制技能树检索工具，**启用技能编排** 控制技能总谱与编排工具，**启用动态图谱** 控制 Session 执行轨迹是否参与学习和后续编排。技能索引页提供索引构建、重新构建、取消构建、查看构建状态和查看索引树等操作；技能总谱页提供读谱、增量构建、暂停构建和全量重新构建等操作。
