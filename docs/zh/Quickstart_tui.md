...
JiuwenAvatar提供两种安装方式：`pip安装`或`源码安装`。
...
- 创建虚拟环境 & 安装 jiuwenavatar 项目

  ```bash
  # 创建名为 jiuwenavatar 的虚拟环境
  python -m venv jiuwenavatar

  # Windows 激活 jiuwenavatar 虚拟环境
  jiuwenavatar\Scripts\activate

  # Mac 激活 jiuwenavatar 虚拟环境
...
- 启动 jiuwenavatar-tui 项目
  ```bash
  # 另打开终端界面，启动 JiuwenAvatar-tui
  jiuwenavatar-tui
  ```
...
- 安装TUI依赖
  另外打开新终端界面，进入TUI目录 jiuwenavatar/channels/tui/frontend 安装依赖：
  ```bash
