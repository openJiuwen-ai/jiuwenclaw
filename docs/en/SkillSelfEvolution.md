...
The system automatically detects evolution signals after each tool execution and dialogue completion. When execution exceptions or user corrections are detected, it generates candidate evolution records.
