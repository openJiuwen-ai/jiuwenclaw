...
This page collects common JiuwenAvatar usage instructions and feature documentation.
...
|---|---|---|
| **Code Review Assistant** | [Code Review Assistant](development-practices/JiuwenAvatar-Code-Review-Assistant.md) | Building a code review workflow. |
| **Daily Report Generator** | [Daily Report Generator](development-practices/JiuwenAvatar-Daily-Report-Generator.md) | Agent development case for automatically summarizing daily work reports. |
