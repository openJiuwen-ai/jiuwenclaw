...
Task Memory is JiuwenAvatar's built-in experience system that allows the Agent to retrieve, record, and consolidate lessons from past tasks — avoiding repeated mistakes and reusing effective solutions in future tasks.
