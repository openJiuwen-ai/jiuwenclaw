...
How to create and manage a simple scheduled job in JiuwenAvatar and push results to a channel (e.g. web, Feishu).
...
3. Save. Jobs are stored in `~/.jiuwenavatar/workspace/cron_jobs.json` and picked up by the scheduler.
