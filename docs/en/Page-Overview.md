# JiuwenAvatar page overview (web)
...
The JiuwenAvatar web app uses a classic three-column layout—common in professional tools and dev platforms—so information stays organized and actions are easy to reach.
...
![JiuwenAvatar web UI: three-column layout](../assets/images/jiuwenavatar布局概览.png)
...
![JiuwenAvatar version in the web UI](../assets/images/jiuwenavatar版本号.png)

- **What:** current JiuwenAvatar version
...
The primary surface for talking to JiuwenAvatar.
...
![JiuwenAvatar chat: messages, reply, and tools](../assets/images/jiuwenavatar显示内容.png)

### 2. Execution modes

JiuwenAvatar offers three execution modes. Pick the one that fits the task. Names in the app follow the UI (English strings are typically *Planning mode*, *Performance mode*, and *Cluster mode* in `en.json`).
...
![Execution mode selector](../assets/images/jiuwenavatar执行模式.png)
...
**Running (example)**  
![Task running](../assets/images/jiuwenavatar处理中.png)

**Paused (example)**  
![Task paused](../assets/images/jiuwenavatar暂停.png)

**Cancelled (example)**  
![Task cancelled](../assets/images/jiuwenavatar取消.png)
...
![Status and auxiliary area](../assets/images/jiuwenavatar辅助信息展示.png)
