...
check_if_mysql_up() {
    ...
    DEPLOY_VARS["IDENTITY_DB_USER"]="root"
    DEPLOY_VARS["IDENTITY_DB_PASSWORD"]=${DEPLOY_VARS["MYSQL_ROOT_PASSWORD"]}
}
...
check_if_postgresql_up() {
    ...
    DEPLOY_VARS["IDENTITY_DB_USER"]="postgres"
    DEPLOY_VARS["IDENTITY_DB_PASSWORD"]=${DEPLOY_VARS["POSTGRES_PASSWORD"]}
}
