...
POOL_TEMPLATE_FILE="${TEMPLATE_DIR}/pool.template.json"
POOL_FILE="${CONFIG_DIR}/pool.json"
CLAW_META_TEMPLATE_FILE="${TEMPLATE_DIR}/claw_meta.template.json"
CLAW_META_FILE="${CONFIG_DIR}/claw_meta.json"
