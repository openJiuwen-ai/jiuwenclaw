...
#define MyAppVersion "0.2.4.beta3"
...
Filename: "{sys}\icacls.exe"; Parameters: """{app}\runtime\webview2"" /grant *S-1-15-2-2:(OI)(CI)(RX) /grant *S-1-15-2-1:(OI)(CI)(RX) /T /C"; StatusMsg: "Configuring WebView2 Runtime permissions..."; Flags: runhidden waituntilterminated
